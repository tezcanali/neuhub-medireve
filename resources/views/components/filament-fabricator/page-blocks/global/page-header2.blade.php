...
<div class="hero hero-page bg-primary position-relative overflow-hidden">
    <div class="shape-1 position-absolute top-0">
        <svg width="185" height="200" viewBox="0 0 185 249" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M82.4991 1.5C77.1658 55.1667 89.9991 179.7 183.999 248.5" stroke="#5969AE"></path>
            <path d="M82.4991 1.5C77.1658 55.1667 89.9991 179.7 183.999 248.5" stroke="#5969AE"></path>
            <path d="M61.3893 1C64.5625 32.9393 56.927 107.054 1 148" stroke="#5969AE"></path>
            <path d="M61.3893 1C64.5625 32.9393 56.927 107.054 1 148" stroke="#5969AE"></path>
        </svg>
    </div>
    <a href="#"
       ...
       role="alert">
        <div class="container-xl d-flex align-items-center justify-content-between">
            <div class="m-auto d-flex align-items-center gap-4">
                <div class="text-secondary">Recognized Leader in Hair Transplansdfdsts</div>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="icon">
                        <svg width="18" height="30" viewBox="0 0 18 30" fill="none" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink">
                            <rect width="18" height="30" fill="url(#pattern0_29_1758)"></rect>
                            <defs>
                                <pattern id="pattern0_29_1758" patternContentUnits="objectBoundingBox" width="1"
                                         height="1">
    ...
    <div class="container-xl position-relative z-3">
        ...
        <p class="text-white mb-0 pb-lg-4">
            {{ $description }}
        </p>
    </div>
</div>

...
<div class="hero hero-page bg-primary position-relative overflow-hidden">
    ...
    <div class="container-xl position-relative z-3" id="formmedireve">
        ...
        <div class="fs-1 fw-light text-gray-400">{{ $page->title }}</div>
        <div class="pt-4">
            <div class="fs-60 fw-light text-gray-400 mb-3">{{ $formTitle }}</div>
            <div class="row">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <a href="https://www.google.com/maps/place/Se%C3%A7kin+Sk.+No:2+Z+ofis/data=!4m7!3m6!1s0x14cab6dc702c74a3:0xd5bb66645f8b8c7a!8m2!3d41.0767492!4d28.971034!16s%2Fg%2F11vf4c7w2_!19sChIJo3QscNy2yhQReoyLX2Rmu9U?coh=219680&utm_campaign=tt-rcs&entry=tts&g_ep=EgoyMDI0MDkxOC4xKgBIAVAD">
                        ...
                        @foreach($address as $item)
                            @if($item['title'])
                                <div class="mb-4">
                                    <div class="fs-18 fw-light text-teal pb-2">{{ $item['title'] }}</div>
                                    <div class="fs-18 text-gray-400"> {!! $item['address'] !!}</div>
                                </div>
                            @endif
                        @endforeach
                        <div class="d-flex flex-column gap-3">
                            <a href="tel:{{ $callbtnNumber }}" class="call-box d-flex align-items-center gap-4 rounded-pill px-4 py-2">
                                ...
                                <div class="d-flex flex-column fw-light fs-18">
                                    <span>{{ $callbtnTitle }}</span>
                                    <span>{{ $callbtnNumber }}</span>
                                </div>
                            </a>
                            <a href="https://wa.me/{{ $wpNumber }}" class="write-box d-flex align-items-center gap-4 rounded-pill px-4 py-2">
                                <div class="icon flex-shrink-0">
